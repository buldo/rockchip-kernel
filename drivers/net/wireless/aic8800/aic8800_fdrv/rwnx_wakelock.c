...
#if defined(CONFIG_PLATFORM_ROCKCHIP2) || defined(CONFIG_PLATFORM_ROCKCHIP) || defined(CONFIG_ARCH_ROCKCHIP)
...
#else
	return wakeup_source_register(name);
#endif//#if defined(CONFIG_PLATFORM_ROCKCHIP2) || defined(CONFIG_PLATFORM_ROCKCHIP) || defined(CONFIG_ARCH_ROCKCHIP)
